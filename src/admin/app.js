  ...
  config: {
    ...
    translations: {
      ru: {
        ...
        "content-type-builder.plugin.name": "Конструктор контента",
        "dark": "Тёмная",
        ...
        "light": "Светлая",
        "listView.headerLayout.description": "Построение архитектуры контента",
        "menu.section.components.name": "Компоненты",
        "menu.section.models.name": "Коллекции",
        "menu.section.single-types.name": "Страницы",
